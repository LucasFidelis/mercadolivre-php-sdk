...
class SaleTerms
{
	...
	public function getValueStruct(): ?ValueStruct
	{
	...
	public function setValueStruct(?ValueStruct $valueStruct): self
	{
		$this->valueStruct = $valueStruct;
		return $this;
	}
	...
	public static function fromJson(array $data): self
	{
		return new self(
			...
			$data['value_id'] ?? null,
			$data['value_name'],
			($data['value_struct'] ?? null) !== null ? ValueStruct::fromJson($data['value_struct']) : null,
